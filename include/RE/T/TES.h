...
namespace RE
{
	...
	public:
		...
		NiPointer<SceneGraph>                           worldSceneGraph;   // 1F0
		NiPointer<SceneGraph>                           menuSceneGraph;    // 1F8
		NiPointer<SceneGraph>                           menu3dSceneGraph;  // 200
		NiPointer<BSMultiBoundNode>                     skyNode;           // 208
		NiPointer<NiNode>                               weatherNode;       // 210
		NiPointer<BSFogProperty>                        fog;               // 218
