...
namespace RE
{
	...
	public:
		...
		virtual GFxMovieView*                        CreateInstance1(MemoryContext* a_memContext, bool a_initFirstFrame = true) = 0;                                 // 17
		virtual GFxMovieView*                        CreateInstance2(const MemoryParams& a_memParams, bool a_initFirstFrame = true) = 0;                             // 18
